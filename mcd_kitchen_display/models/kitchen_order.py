...
class KitchenOrder(models.Model):
    ...
    name = fields.Char(
        ...
        required=True,
        copy=False,
        default=lambda self: self.env['ir.sequence'].next_by_code('kitchen.order') or '/',
    )
                ...
                'lines': [
                    {
                        ...
                        'qty': line.qty,
                        'modifier_note': line.modifier_note or '',  # FIX: thêm modifier_note
                    }
